...
import { CartItem as CartItemProp } from "../../interfaces/cart-item.interface";
import Card from "../../ui-components/card/card";
import classes from './cart-item.module.css';
import { formatPrice } from "../../utils/format-price.util";

interface CartItemProps extends PropsWithChildren {
  readonly cartItem: CartItemProp;
  readonly removeItemFromCart: (cartItem: CartItemProp) => void;
}
